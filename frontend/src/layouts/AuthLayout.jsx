        ...
        <div className="h-screen flex bg-surface">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 xl:p-24 bg-page-bg lg:bg-surface relative">
                ...
                <div className="w-full max-w-md">
                    <Link
                        to="/"
                        className="w-40 mb-4 flex items-center justify-center gap-2 text-gray-500 font-medium hover:text-cta! transition-colors bg-gray-100 hover:bg-amber-50! px-4 py-2 rounded-full"
                    >
